diff --git a//dev/null b/ui/supplier_tab.py
index 0000000000000000000000000000000000000000..0308e0eef38815db836c772ea2581274423fe144 100644
--- a//dev/null
+++ b/ui/supplier_tab.py
@@ -0,0 +1,50 @@
